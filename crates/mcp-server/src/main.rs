...
tool_args! {
    ...
    schema object_tool_schema(
        json!({
            ...
            "posting_operation_id": {"type": ["string", "null"], "format": "uuid", "description": "Stable posting journey identifier. Reuse it when resuming or retrying the same operation. A new identifier is generated if omitted."},
