...
mod tests {
    ...
    #[test]
    fn routed_v3_agent_wallet_ux_economics_produce_one_usdc_gross_margin() {
        let created_at = DateTime::<Utc>::from_timestamp(1_800_000_000, 0).unwrap();
        let document: AutonomousBountyTermsDocument =
            serde_json::from_str(include_str!("../../../bounties/autonomous-v1/649.json"))
                .unwrap();
        let terms = build_autonomous_bounty_terms_record(
            "0x41f7f2722f0af7289c2f2eea6afed6f4873f722a",
            document,
            created_at,
        )
        .unwrap();
        ...
        let item = AutonomousBountyFeedItem {
            bounty_id: format!("0x{}", "ab".repeat(32)),
            bounty_contract: "0x41f7f2722f0af7289c2f2eea6afed6f4873f722a".to_string(),
            creator: "0x41f7f2722f0af7289c2f2eea6afed6f4873f722a".to_string(),
            status: "claimable".to_string(),
