...
Open Competition is the primary product path, with V2 primary for new work, V1 retained for historical and client compatibility, and autonomous exclusive claims retained as the legacy path. The evaluator preserves those roles and protocol identity through its ledger and rollout snapshots. This product priority never changes a unit's qualification or weight in the marketplace-wide north star. V2 broadens deterministic work through reviewed proof programs; it does not make subjective or unreviewed work automatically eligible.
