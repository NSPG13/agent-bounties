  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Verify reviewed worker build inputs", "run": "python scripts/regression_verifier_source_guard.py --scope worker-build --expected-sha256 729292ae87e115ab2d00d7c0d580bd37e229aaea682517d2de2202942bfce064"},
        {"name": "Build isolated regression worker", "run": "cargo build --release -p worker"},
        {"name": "Revalidate reviewed sources after build", "run": "python scripts/regression_verifier_source_guard.py --scope worker-build --expected-sha256 729292ae87e115ab2d00d7c0d580bd37e229aaea682517d2de2202942bfce064"},
        {"name": "Revalidate reviewed signing runtime", "run": "python scripts/regression_verifier_source_guard.py --scope signing-runtime --expected-sha256 0003d29adff6c0489e5323d431cdae28c129cfcc10b6c17bd0ae11d4385f235e"},
