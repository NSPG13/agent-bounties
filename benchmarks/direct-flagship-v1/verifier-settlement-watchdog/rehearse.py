  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Verify reviewed worker build inputs", "run": "python scripts/regression_verifier_source_guard.py --scope worker-build --expected-sha256 ae141a33cd1baa8db0b0f86acdcb57112aa1822ffc7638d329d02867d3a0f50b"},
        {"name": "Build isolated regression worker", "run": "cargo build --release -p worker"},
        {"name": "Revalidate reviewed sources after build", "run": "python scripts/regression_verifier_source_guard.py --scope worker-build --expected-sha256 ae141a33cd1baa8db0b0f86acdcb57112aa1822ffc7638d329d02867d3a0f50b"},
