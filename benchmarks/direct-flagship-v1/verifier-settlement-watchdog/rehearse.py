  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Revalidate reviewed signing runtime", "run": "python scripts/regression_verifier_source_guard.py --scope signing-runtime --expected-sha256 b4ddbcb4b5b564d638335c4868ccf5dfd8ea7a8c2167f2876bbd4d28a76f352b"},
