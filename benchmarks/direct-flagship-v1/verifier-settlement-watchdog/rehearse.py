  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Revalidate reviewed signing runtime", "run": "python scripts/regression_verifier_source_guard.py --scope signing-runtime --expected-sha256 59ff86782a43cc6ff6276c496c07cfde613a0d0f14d2d570e9cd55e7741714eb"},
