  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Revalidate reviewed signing runtime", "run": "python scripts/regression_verifier_source_guard.py --scope signing-runtime --expected-sha256 51b5c0bbfcd6eff172d0ac64ddf6374c57b595b4095c1492595f8e51509eed96"},
