  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Revalidate reviewed signing runtime", "run": "python scripts/regression_verifier_source_guard.py --scope signing-runtime --expected-sha256 2c382ad0d469d9c2ad74819968cacbe4bd30fe430585a39bab6dfc02a0b90e63"},
