  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Verify reviewed worker build inputs", "run": "python scripts/regression_verifier_source_guard.py --scope worker-build --expected-sha256 e11407bce1db901466da6da7b18bbdc5057812de538b71d5299d4e7f827086d9"},
        {"name": "Build isolated regression worker", "run": "cargo build --release -p worker"},
        {"name": "Revalidate reviewed sources after build", "run": "python scripts/regression_verifier_source_guard.py --scope worker-build --expected-sha256 e11407bce1db901466da6da7b18bbdc5057812de538b71d5299d4e7f827086d9"},
