  ...
  "jobs": {
    "run-no-secrets": {
      ...
      "steps": [
        ...
        {"name": "Revalidate reviewed signing runtime", "run": "python scripts/regression_verifier_source_guard.py --scope signing-runtime --expected-sha256 d2933a7ceeceb78d9d97f2a17d21effbde123bb966f0965d1783679a547dfbd5"},
