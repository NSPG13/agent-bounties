...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-forward-fortnight-20260907.mjs");
...
console.log(`gmv_forward_fortnight_20260907_benchmark=passed cases=${cases.length}`);
