...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-forward-20260831.mjs");
...
console.log(`gmv_forward_week_20260831_benchmark=passed cases=${cases.length}`);
