...
const ready = {"ready": true, "protocol": "https", "expected_statuses": [200, 201, 204], "timeout": 5, "retry_strategy": "exponential_backoff", "max_retries": 3, "health_check_interval": 30, "required_metrics": ["latency_p95", "error_rate", "uptime_percentage", "throughput_rps"]};

const invalidErrors = ["schema_mismatch", "protocol_mismatch", "endpoint_pattern_mismatch", "status_code_unknown", "timeout_mismatch", "retry_strategy_mismatch", "max_retries_mismatch", "health_check_interval_mismatch", "required_metric_missing:latency_p95", "required_metric_missing:error_rate", "required_metric_missing:uptime_percentage", "required_metric_missing:throughput_rps"];
