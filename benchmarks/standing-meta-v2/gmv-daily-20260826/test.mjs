...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-20260826.mjs");
...
const ready = {
  ...
  bounty_id: "0xc9507d73785ce4abfcfb147d135849e8df560df4c201506c657fcafd2bcb257d",
...
console.log(`gmv_daily_20260826_benchmark=passed cases=${cases.length}`);
