...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-forward-20260824.mjs");
...
console.log(`gmv_forward_week_20260824_benchmark=passed cases=${cases.length}`);
