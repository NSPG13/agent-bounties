...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-forward-sprint-20260824.mjs");
...
console.log(`gmv_forward_sprint_20260824_benchmark=passed cases=${cases.length}`);
