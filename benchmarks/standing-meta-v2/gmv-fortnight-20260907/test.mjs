...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-20260907.mjs");
...
const ready = {
  ...
  bounty_id: "0x6f4939b0e12c8dd5d84efbfec0c7933bcdfcac9fb012c1b63014c6a6be7cad04",
...
console.log(`gmv_fortnight_20260907_benchmark=passed cases=${cases.length}`);
