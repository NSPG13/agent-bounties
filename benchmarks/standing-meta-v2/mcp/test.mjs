...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-mcp.mjs");
...
const ready = {
  ...
  required_tools: ["route_blocked_goal", "prepare_agent_to_earn", "agent_native_claim", "list_bounties", "get_bounty_status"],
};
...
const invalidProtocolErrors = [
  ...
  "required_tool_missing:list_bounties",
  "required_tool_missing:get_bounty_status",
];
