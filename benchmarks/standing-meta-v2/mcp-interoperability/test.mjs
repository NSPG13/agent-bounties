...
const ready = {
  ready: true,
  transport_protocols: ["stdio", "sse", "streamable_http"],
  auth_methods: ["oauth2", "api_key", "none"],
  required_capabilities: ["tools_list", "resources_read", "prompts_get", "sampling_createMessage", "roots_list"],
...
const invalidErrors = [
  "schema_mismatch",
  "transport_protocol_missing:stdio",
  "transport_protocol_missing:sse",
  "transport_protocol_missing:streamable_http",
  "auth_method_invalid",
  "capability_missing:tools_list",
  "capability_missing:resources_read",
  "capability_missing:prompts_get",
  "capability_missing:sampling_createMessage",
  "capability_missing:roots_list",
  "protocol_version_mismatch",
  "max_tools_mismatch",
  "heartbeat_interval_mismatch",
];
...
for (const c of cases) {
  ...
  let actualOutput;
  try { actualOutput = JSON.parse((result.stdout ?? "").trim()); } catch { actualOutput = null; }
