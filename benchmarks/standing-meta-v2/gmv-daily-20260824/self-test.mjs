...
function source(name, implementation) {
  ...
  writeFileSync(join(scripts, "check-agent-bounties-gmv-20260824.mjs"), implementation);
  return root;
}
...
const originalCheckerPath = join(
  ...
  "..",
  "scripts",
  "check-agent-bounties-gmv-20260824.mjs",
);
const knownGood = readFileSync(originalCheckerPath, "utf8");

const alwaysReady = `
console.log(JSON.stringify({ready:true,network:"base-mainnet",competition:"0x8c494466711c1de316c7e7599f8b0641a30a0c98",bounty_id:"0x6901f3ecf52842689a4209aac6fa7d8af205a6d2a546d567b77705e06c0a8c9a",gmv_base_units:900000,status:"eligible"}));
`;
...
try {
  ...
  console.log("gmv_daily_20260824_benchmark_self_test=passed");
} finally {
