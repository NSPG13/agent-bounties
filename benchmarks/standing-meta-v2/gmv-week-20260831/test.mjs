...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-20260831.mjs");
...
const ready = {
  ...
  bounty_id: "0x46a5a34d8596f6f54efae2487e4ef7906ff3940583a97b9d266ef15c45c3df67",
...
console.log(`gmv_week_20260831_benchmark=passed cases=${cases.length}`);
