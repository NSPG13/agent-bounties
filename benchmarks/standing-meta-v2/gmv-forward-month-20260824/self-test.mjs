...
function source(name, implementation) {
  ...
  writeFileSync(join(scripts, "check-agent-bounties-gmv-forward-month-20260824.mjs"), implementation);
  return root;
}
...
const originalCheckerPath = join(
  ...
  "..",
  "scripts",
  "check-agent-bounties-gmv-forward-month-20260824.mjs",
);
const knownGood = readFileSync(originalCheckerPath, "utf8");

const alwaysReady = `
console.log(JSON.stringify({ready:true,network:"base-mainnet",competition:"0x8c990ddf5360c00ee0b2090000e3a3a6f90a6a9d",bounty_id:"0x54684252bfcece3e9258af16f337391498b1fefd9cbb7690abe149ad5bee60c6",gmv_base_units:900000,status:"eligible"}));
`;
...
try {
  ...
  console.log("gmv_forward_month_20260824_benchmark_self_test=passed");
} finally {
