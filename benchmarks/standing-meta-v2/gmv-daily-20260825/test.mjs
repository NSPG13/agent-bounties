...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-20260825.mjs");
...
const ready = {
  ...
  bounty_id: "0x08f50f85dcda47753ac40791503af0aa08459169204da94f4769469270abf4de",
...
console.log(`gmv_daily_20260825_benchmark=passed cases=${cases.length}`);
