...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-forward-fortnight-20260824.mjs");
...
console.log(`gmv_forward_fortnight_20260824_benchmark=passed cases=${cases.length}`);
