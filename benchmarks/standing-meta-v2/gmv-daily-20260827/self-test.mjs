...
function source(name, implementation) {
  ...
  writeFileSync(join(scripts, "check-agent-bounties-gmv-20260827.mjs"), implementation);
  return root;
}
...
const originalCheckerPath = join(benchmarkRoot, "..", "..", "..", "scripts", "check-agent-bounties-gmv-20260827.mjs");
const knownGood = readFileSync(originalCheckerPath, "utf8");

const alwaysReady = `
console.log(JSON.stringify({ready:true,network:"base-mainnet",competition:"0xee01479015026afc2b09dea37d2ed805926c3c0d",bounty_id:"0x184ac3c4046a401263cc2ba4217a5aa58e47d2304619e1fc112620cd7598a45e",gmv_base_units:900000,status:"eligible"}));
`;
...
try {
  ...
  console.log("gmv_daily_20260827_benchmark_self_test=passed");
} finally {
