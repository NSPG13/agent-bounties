...
const checker = join(sourceRoot, "scripts", "check-agent-bounties-gmv-20260827.mjs");
...
const ready = {
  ...
  bounty_id: "0x184ac3c4046a401263cc2ba4217a5aa58e47d2304619e1fc112620cd7598a45e",
...
console.log(`gmv_daily_20260827_benchmark=passed cases=${cases.length}`);
