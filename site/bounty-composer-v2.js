(() => {
  ...
  async function chooseCryptoWallet() {
    ...
    if(!providers.length){ui.walletMessage.textContent="The embedded wallet is not active and no compatible existing wallet was detected. Configure Coinbase CDP or open a Base-compatible wallet, then try again. Never enter a recovery phrase on this website.";return;}
