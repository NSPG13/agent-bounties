...
2. `test_geometry.py` reads the **exported mesh** (the artifact a CAD kernel, a
   ...
   void). Re-render first with `python3 test_geometry.py --render`.
...
|---|---|
| `flower_rainwater_collector.stl` | `openscad -o exports/flower_rainwater_collector.stl flower_rainwater_collector.scad` |
| `flower_rainwater_collector.step` | `python3 export_step.py` (OpenCascade, after the STL) |
| `assembly_drawing.svg` | `openscad -D render_assembly=false -o exports/assembly_drawing.svg assembly_drawing.scad` |
