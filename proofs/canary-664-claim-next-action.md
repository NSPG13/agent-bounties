...
Committed path: `scripts/next-agent-claim-action.mjs`  
Source commit above contains this exact file.  
Artifact SHA-256 (raw file bytes): `c76a31e63f689c9609032ed1f5d6fe9452fb79c127a30b31cc5caa7f5a7d0512`
...
- Unknown / unsafe claim states fail closed.
- Output is one compact JSON line per run.
- Bond/solver identifiers unchanged.
- Only canonical `BountySettled` proves payment.
