...
def sync(check=False):
    ...
    for path in sorted((ROOT / "site").rglob("*.html")):
        ...
        home_atmosphere = '    <link rel="stylesheet" href="forest-hall.css?v=11">\n' if relative.as_posix() == "index.html" else ""
        assets = f'''    <link rel="stylesheet" href="{prefix}site-navigation.css?v=5">
    <link rel="stylesheet" href="{prefix}forest-ui.css?v=3">
