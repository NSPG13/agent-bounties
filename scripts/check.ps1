...
Invoke-Checked { & $pythonCommand.Source @pythonArgs -m py_compile scripts\diagnose_hosted_api.py scripts\test_diagnose_hosted_api.py scripts\github_audience_audit.py scripts\test_github_audience_audit.py scripts\ruleset_drift_check.py scripts\test_ruleset_drift_check.py scripts\relay_autonomous_action.py scripts\test_relay_autonomous_action.py scripts\relay_bounded_wallet_action.py scripts\test_relay_bounded_wallet_action.py scripts\bounded_agent_create.py scripts\plan_bounded_agent_budget.py scripts\test_bounded_agent_budget.py scripts\local_delegate_wallet.py scripts\test_local_delegate_wallet.py scripts\self_heal.py scripts\test_self_heal.py scripts\github_issue_plan_comment.py scripts\github_funding_comment.py scripts\github_claim_comment.py scripts\github_proof_comment.py scripts\sync_hosted_bounty_inventory.py scripts\test_sync_hosted_bounty_inventory.py scripts\reconcile_github_bounty_labels.py scripts\test_reconcile_github_bounty_labels.py scripts\validate_real_funding_rehearsal.py }
