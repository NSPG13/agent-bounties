...
class TestOpenCompetitionV2GmvIssue1375(unittest.TestCase):
    """
    Test suite validating campaign configuration, cryptographic policy hashes,
    dual attester signatures, pro-rata scoring, and benchmark execution for Issue 1375.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-forward-week-20260824-v2"
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x7037d741033453aab56a3e57c3f261dd11891bd808be56d67980d0c8263ddd81",
        )
        self.assertEqual(candidate["epoch"]["starts_at"], "2026-08-24T00:00:00Z")
        self.assertEqual(candidate["epoch"]["ends_at"], "2026-08-31T00:00:00Z")
        ...
        self.assertEqual(ends, 1788134400)
        ...
        expected_policy = "0x7be6bc675a54c5c6176d497ba443aab3a7190b65fad345cffc1c02403feac3b0"
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x4ffb4c5f75f2816b1d58c97ae440184bb5e75cbc158dc639b66a7e50e5d81417",
        )
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-forward-week-20260824"
        ...
        self.assertIn("gmv_forward_week_20260824_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_forward_week_20260824_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-forward-week-20260824-child-bounty.md"
        ...
        self.assertIn("0x2f1d2b24105596b153e473032256569fe544a44f", content)
        self.assertIn("0x4ffb4c5f75f2816b1d58c97ae440184bb5e75cbc158dc639b66a7e50e5d81417", content)
