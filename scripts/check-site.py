...
ALLOWED_UI_CODE = {
    "guided-topup.css", "guided-topup.js", "wallet-funding.js",
    "forest-ui.css",
    "forest-theme.js",
    "forest-home.js",
    "forest-hall.js",
...
def check_analytics(site_dir: Path, repo_root: Path) -> None:
    ...
    require_phrases(
        ...
        [
            ...
            '"Creator-review reserve" : "Verifier reward"',
            "formatUsdc(Number(rewards.verifier) / 1_000_000)",
            "The solver supplies its own bond separately.",
        ],
    )
    require_phrases(
...
def check_marketplace(site_dir: Path) -> None:
    ...
    require_phrases(
        ...
        [
            ...
            "data-market-timing",
            '<option value="now" selected>Open now</option>',
            "Upcoming",
            "Scoring closed / proof stage",
            "All funded",
            "Child-funding tasks",
...
def check_transactional_handoffs(site_dir: Path) -> None:
    ...
    require_phrases(
        ...
        [
            ...
            "data-purchase-recovery",
            "funding-readiness.js",
            "MoonPay top-up ≠ bounty funding",
            "Base ETH for new-bounty gas",
            "Return to the bounty review to check sponsorship for the exact action.",
        ],
    )
