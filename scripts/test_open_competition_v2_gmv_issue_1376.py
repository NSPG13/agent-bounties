...
class TestOpenCompetitionV2GmvIssue1376(unittest.TestCase):
    """
    Test suite validating campaign configuration, cryptographic policy hashes,
    dual attester signatures, pro-rata scoring, and benchmark execution for Issue 1376.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-forward-sprint-20260824-v2"
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x34c8b8362111ed2a48f8e73e6b555c2df3e217bf77337d692182545652086647",
        )
        ...
        expected_policy = "0x800333bd3f461b8fca3eb71b6024cd728726d9dfb8e284f6a5a10e161299c2ff"
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x652887c4b67fe6fe8b414074112107347f7e8480d433022252da032f3bcec4cb",
        )
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-forward-sprint-20260824"
        ...
        self.assertIn("gmv_forward_sprint_20260824_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_forward_sprint_20260824_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-forward-sprint-20260824-child-bounty.md"
        ...
        self.assertIn("0x36e45ec89b61f551724558ed799ad4e07c288175", content)
        self.assertIn("0x652887c4b67fe6fe8b414074112107347f7e8480d433022252da032f3bcec4cb", content)
