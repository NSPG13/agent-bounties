...
def compile_python(platform: str) -> None:
    ...
    scripts = [
        ...
        "scripts/build_open_competition_v2_beta3_release.py",
        "scripts/test_build_open_competition_v2_beta3_release.py",
...
def main() -> int:
    ...
    py(
        "-m", "unittest",
        "scripts.test_build_open_competition_v2_beta3_release",
        ...
        "scripts.test_diagnose_open_competition_v2_beta3_prover",
        "scripts.test_install_open_competition_v2_prover_assets",
        "scripts.test_rehearse_open_competition_v2_beta3_prover_service",
        "scripts.test_repair_open_competition_v2_beta3_prover",
