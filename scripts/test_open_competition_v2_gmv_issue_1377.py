...
class TestOpenCompetitionV2GmvIssue1377(unittest.TestCase):
    """
    Test suite validating campaign configuration, cryptographic policy hashes,
    dual attester signatures, pro-rata scoring, and benchmark execution for Issue 1377.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-forward-daily-20260826-v2"
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0xdf2ca136c2bfcf42dfac78584d6b2293bd51339e4fac7373b24f41eadba6288d",
        )
        self.assertEqual(candidate["epoch"]["starts_at"], "2026-08-26T00:00:00Z")
        self.assertEqual(candidate["epoch"]["ends_at"], "2026-08-27T00:00:00Z")
        ...
        self.assertEqual(starts, 1787702400)
        self.assertEqual(ends, 1787788800)
        ...
        expected_policy = "0x0da57d77cd3483cdc3a49e6f3ed05d6d8aff9a346152aca6c03f82b524fd78d8"
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x2bf21872cbf17425daf5e3231c242185ce89fc601320af5d785b87fc50329b8f",
        )
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-forward-daily-20260826"
        ...
        self.assertIn("gmv_forward_daily_20260826_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_forward_daily_20260826_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-forward-daily-20260826-child-bounty.md"
        ...
        self.assertIn("0x441e8bded29917999fc0e8330c83553262fa2f08", content)
        self.assertIn("0x2bf21872cbf17425daf5e3231c242185ce89fc601320af5d785b87fc50329b8f", content)
