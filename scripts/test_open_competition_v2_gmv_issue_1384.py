...
class OpenCompetitionV2GmvIssue1384Tests(unittest.TestCase):
    """
    Validation test suite for Issue #1384: Highest externally funded canonical GMV month August 24 to September 21 campaign.
    """
    ...
    def setUp(self) -> None:
        ...
        for item in self.pool.get("candidates", []):
            if item.get("candidate_id") == "external-gmv-forward-month-20260824-v2":
                candidate = item
                break
        self.assertIsNotNone(candidate, "Candidate external-gmv-forward-month-20260824-v2 must exist")
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0xd9a0ed086fb1b4df2f9e6006bd9330e7fb56ff000c18101a2b2958a39497dcbd",
        )
        ...
        self.assertEqual(
            ...
            "0xf1affeaf2e2cdce4484e596799786f21065a322db67042bda31460484ff4a651",
        )
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        for entry in self.metadata.get("competitions", []):
            if entry.get("seed_id") == "external-gmv-forward-month-20260824-v2":
                match = entry
                break
        self.assertIsNotNone(match, "Public metadata binding for seed external-gmv-forward-month-20260824-v2 must exist")
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "0x54684252bfcece3e9258af16f337391498b1fefd9cbb7690abe149ad5bee60c6",
        )
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-forward-month-20260824"
        ...
        self.assertIn("gmv_forward_month_20260824_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_forward_month_20260824_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-forward-month-20260824-child-bounty.md"
        ...
        self.assertIn("0x8c990ddf5360c00ee0b2090000e3a3a6f90a6a9d", content)
        self.assertIn("0x54684252bfcece3e9258af16f337391498b1fefd9cbb7690abe149ad5bee60c6", content)
