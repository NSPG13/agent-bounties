...
class TestOpenCompetitionV2GmvIssue1378(unittest.TestCase):
    """
    Test suite validating campaign configuration, cryptographic policy hashes,
    dual attester signatures, pro-rata scoring, and benchmark execution for Issue 1378.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-forward-fortnight-20260907-v2"
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x6223c992fe85417a81b97e2895b8e1bc35fccc5eb1ead9d6c4191467734ef5b8",
        )
        ...
        expected_policy = "0xfe9301ba875aaab2c664c3a752a33e4b3e5811c85f003cc29aa8dc914cb04625"
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x3b74c2a80fd55e9ae72bb8f21b8e2b240a32b1d78676f6fe489fde1099694071",
        )
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-forward-fortnight-20260907"
        ...
        self.assertIn("gmv_forward_fortnight_20260907_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_forward_fortnight_20260907_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-forward-fortnight-20260907-child-bounty.md"
        ...
        self.assertIn("0x5817b7742b085d333c7e7831daa62a490c493b56", content)
        self.assertIn("0x3b74c2a80fd55e9ae72bb8f21b8e2b240a32b1d78676f6fe489fde1099694071", content)
