...
class OpenCompetitionV2GmvIssue1388Tests(unittest.TestCase):
    """
    Validation test suite for Open Competition V2 daily 20260827 forward GMV issue 1388.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-reward-6usdc-daily-20260827-v1"
        cls.candidate = next(
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x184ac3c4046a401263cc2ba4217a5aa58e47d2304619e1fc112620cd7598a45e",
        )
        self.assertEqual(
            candidate["epoch"]["epoch_id"].lower(),
            "0x8ea3eec80412bbe126fad9e043c1d40e41adaeeff13017947e5877484db173fe",
        )
        ...
        expected_policy = "0x438a46f8103de81b96fe48de248c8908f509b21fa8254a5355e8a04c94277528"
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-daily-20260827"
        ...
        self.assertIn("gmv_daily_20260827_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_daily_20260827_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-daily-20260827-child-bounty.md"
        ...
        self.assertIn("0xee01479015026afc2b09dea37d2ed805926c3c0d", content)
        self.assertIn("0x184ac3c4046a401263cc2ba4217a5aa58e47d2304619e1fc112620cd7598a45e", content)
