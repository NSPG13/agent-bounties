...
class TestOpenCompetitionV2GmvIssue1380(unittest.TestCase):
    """
    Test suite validating campaign configuration, cryptographic policy hashes,
    dual attester signatures, pro-rata scoring, and benchmark execution for Issue 1380.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-forward-daily-20260825-v2"
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0xb00494c5d310614a1f9421e522ae76ea9b520cdcb138abebd41939d724b821fa",
        )
        ...
        expected_policy = "0xccdd16fce26d6a4a1b86f67aa22241f4fe71af0c09d38d793bc2fbddaf203c75"
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        self.assertEqual(
            ...
            "0xf2d4a90fa4bbf9bec25a44b014c1b640cf11449bb3ec35f7f70597db0958e8eb",
        )
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        self.assertIn("0x6a791b05333d9ca7d28a052003ced4818a372c7f", content)
        self.assertIn("0xf2d4a90fa4bbf9bec25a44b014c1b640cf11449bb3ec35f7f70597db0958e8eb", content)
