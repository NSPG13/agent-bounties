            ...
            "metric_profiles": [
                {
                    ...
                    "journal_schema_hash": digest("f"),
                    "metric_program_hash": digest("0"),
                    "review_evidence_hash": digest("1"),
                },
                {
                    "profile_id": "structured-artifact-metric-v1",
                    "program_vkey": digest("1"),
                    "source_hash": digest("2"),
                    "elf_hash": digest("3"),
                    "elf_sha256": "3" * 64,
                    "journal_schema_hash": digest("4"),
                    "metric_program_hash": digest("5"),
                    "review_evidence_hash": digest("6"),
                },
            ],
            "activation": {
