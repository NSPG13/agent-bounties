...
class OpenCompetitionV2GmvIssue1379Tests(unittest.TestCase):
    """
    Validation test suite for Open Competition V2 daily 20260826 forward GMV issue 1379.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-reward-6usdc-daily-20260826-v1"
        cls.candidate = next(
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0xc9507d73785ce4abfcfb147d135849e8df560df4c201506c657fcafd2bcb257d",
        )
        self.assertEqual(
            candidate["epoch"]["epoch_id"].lower(),
            "0x66ea8b217cc2cc08c45382405d7bae18cbd9eebc96e3745c8d928562254c68df",
        )
        ...
        expected_policy = "0x6ead994859b7e72db2f9d621a03aa0c2d685d20573f56b326717b33a3ce93e23"
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-daily-20260826"
        ...
        self.assertIn("gmv_daily_20260826_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_daily_20260826_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-daily-20260826-child-bounty.md"
        ...
        self.assertIn("0x5a096ba0dc8f647cc499d14cd82ff49eef05b828", content)
        self.assertIn("0xc9507d73785ce4abfcfb147d135849e8df560df4c201506c657fcafd2bcb257d", content)
