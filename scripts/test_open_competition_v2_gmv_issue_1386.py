...
class OpenCompetitionV2GmvIssue1386Tests(unittest.TestCase):
    """
    Validation test suite for Open Competition V2 daily 20260825 forward GMV issue 1386.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-reward-6usdc-daily-20260825-v1"
        cls.candidate = next(
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x08f50f85dcda47753ac40791503af0aa08459169204da94f4769469270abf4de",
        )
        self.assertEqual(
            candidate["epoch"]["epoch_id"].lower(),
            "0x170f7705d98a3116c6e7bb2c6c49ece365eda281ca2be2033f8d4e40a6c6f289",
        )
        self.assertEqual(candidate["epoch"]["starts_at"], "2026-08-25T00:00:00Z")
        self.assertEqual(candidate["epoch"]["ends_at"], "2026-08-26T00:00:00Z")
        ...
        self.assertEqual(starts, 1787616000)
        self.assertEqual(ends, 1787702400)
        ...
        expected_policy = "0xa81438779807146f343271f1350d2e2bb811e61c617d95978f0c883de6a3cebc"
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-daily-20260825"
        ...
        self.assertIn("gmv_daily_20260825_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_daily_20260825_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-daily-20260825-child-bounty.md"
        ...
        self.assertIn("0xbab4de620cee1286307d6551bc5c2816dc27d45a", content)
        self.assertIn("0x08f50f85dcda47753ac40791503af0aa08459169204da94f4769469270abf4de", content)
