...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    receipts["fund_solver_a_usdc"] = client.send(signer, to=token, data=rehearsal.function_data("transfer(address,uint256)", ["address", "uint256"], [solver_a.address, 162_500]))
