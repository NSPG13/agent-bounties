...
class TestOpenCompetitionV2GmvIssue1381(unittest.TestCase):
    """
    Test suite validating campaign configuration, cryptographic policy hashes,
    dual attester signatures, pro-rata scoring, and benchmark execution for Issue 1381.
    """
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_candidate = "external-gmv-forward-fortnight-20260824-v2"
    ...
    def test_campaign_metadata_and_policy_hash_identity(self) -> None:
        ...
        self.assertEqual(
            ...
            "0xf4954bbd1a48ec059078bfbb84a24cd68d35e8837631a562704dbe83edde5a9d",
        )
        ...
        expected_policy = "0xcd88233c773ba4804318df8423e0313bbf733edd48cd0117d87100750fb36f76"
    ...
    def test_public_metadata_registry_binding(self) -> None:
        ...
        self.assertEqual(
            ...
            "0x650ab64c02cba5dd8d3d4f3efcc1bf4c2c8125d2fea0e13b69e8e326f1b8b81f",
        )
    ...
    def test_benchmark_runner_and_self_test(self) -> None:
        ...
        """
        benchmark_dir = ROOT / "benchmarks" / "standing-meta-v2" / "gmv-forward-fortnight-20260824"
        ...
        self.assertIn("gmv_forward_fortnight_20260824_benchmark=passed cases=9", runner_res.stdout)
        ...
        self.assertIn("gmv_forward_fortnight_20260824_benchmark_self_test=passed", selftest_res.stdout)
    ...
    def test_child_bounty_specification_document(self) -> None:
        ...
        """
        bounty_file = ROOT / "bounties" / "gmv-forward-fortnight-20260824-child-bounty.md"
        ...
        self.assertIn("0x6f635dfd07085aa48ec8b11767eeb48936969f5c", content)
        self.assertIn("0x650ab64c02cba5dd8d3d4f3efcc1bf4c2c8125d2fea0e13b69e8e326f1b8b81f", content)
